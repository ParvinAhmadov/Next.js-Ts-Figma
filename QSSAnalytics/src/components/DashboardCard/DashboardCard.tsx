    ...
    >
      ...
      {active && (
        <Link href={buttonHref}>
          <button className="px-4   py-2 w-full rounded-md font-medium bg-[#CC3203] cursor-pointer text-white hover:bg-orange-600 transition text-[clamp(0.875rem,2vw,1rem)]">
            {buttonLabel}
          </button>
        </Link>
      )}
